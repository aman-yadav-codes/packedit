...
print_final_box() {
    ...
    echo -e "${GREEN}  ╔══════════════════════════════════════════╗${NC}"
    echo -e "${GREEN}  ║                                          ║${NC}"
    echo -e "${GREEN}  ║   ${YELLOW}✔  MODDERS CORE INSTALLED!${GREEN}            ║${NC}"
    echo -e "${GREEN}  ║                                          ║${NC}"
    echo -e "${GREEN}  ╠══════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}  ║                                          ║${NC}"
    ...
    echo -e "${GREEN}  ║   ${DIM}~/Modders_Core/${NC}${GREEN}                       ║${NC}"
    echo -e "${GREEN}  ║                                          ║${NC}"
    echo -e "${GREEN}  ║   ${WHITE}GLOBAL CMD:${GREEN}                           ║${NC}"
    echo -e "${GREEN}  ║   ${DIM}\$PREFIX/bin/Modders_Core${NC}${GREEN}              ║${NC}"
    echo -e "${GREEN}  ║                                          ║${NC}"
    echo -e "${GREEN}  ╠══════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}  ║                                          ║${NC}"
...
if [ -d "$HOME/Modders_Core" ]; then
    ...
    git clone https://github.com/aman-yadav-codes/packedit.git "$HOME/Modders_Core" 2>&1 | \
